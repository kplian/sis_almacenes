  ...
  ***********************************/
  ...
  if(p_transaccion='SAL_PREDET_SEL')then
      ...
      v_consulta:='select
            ...
            predet.fecha_compra,
            predet.id_centro_costo,
            predet.id_ubicacion,
            predet.id_grupo,
            predet.id_grupo_clasif,
            cc.codigo_tcc,
            ubi.nombre as desc_ubicacion,
            ...
            left join kaf.tubicacion ubi on ubi.id_ubicacion = predet.id_ubicacion
            left join kaf.tgrupo gru on gru.id_grupo = predet.id_grupo
            left join kaf.tgrupo gru1 on gru1.id_grupo = predet.id_grupo_clasif
            where  ';
